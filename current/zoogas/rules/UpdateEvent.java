...
public class UpdateEvent {
    ...
    public Point sourceCoords = null;
    Point targetCoords = null;
    ...
    private void initBondLabel() {
        if ((pattern.requiredLhsBond != null && pattern.requiredLhsBond.size() > 0) || (pattern.optionalLhsBond != null && pattern.optionalLhsBond.size() > 0) || (pattern.excludedLhsBond != null && pattern.excludedLhsBond.size() > 0) || (pattern.rhsBond != null && pattern.rhsBond.size() > 0)) {
    ...
    public boolean equals(Object obj) {
        if (obj.getClass().equals(getClass())) {
            ...
            if (eq && pattern != null) {
                if (pattern.requiredLhsBond != null)
                    eq = eq && pp.pattern != null && pattern.requiredLhsBond.equals(pp.pattern.requiredLhsBond);
                if (pattern.optionalLhsBond != null)
                    eq = eq && pp.pattern != null && pattern.optionalLhsBond.equals(pp.pattern.optionalLhsBond);
                if (pattern.excludedLhsBond != null)
                    eq = eq && pp.pattern != null && pattern.excludedLhsBond.equals(pp.pattern.excludedLhsBond);
                if (pattern.rhsBond != null)
                    eq = eq && pp.pattern != null && pattern.rhsBond.equals(pp.pattern.rhsBond);
            }
            return eq;
        }
        return false;
    ...
    public int hashCode() {
        int code = 0;
        if (source != null)
            code = code ^ source.hashCode();
        if (target != null)
            code = code ^ target.hashCode();
        if (pattern != null) {
            if (pattern.requiredLhsBond != null)
                code = code ^ pattern.requiredLhsBond.hashCode();
            if (pattern.optionalLhsBond != null)
                code = code ^ pattern.optionalLhsBond.hashCode();
            if (pattern.excludedLhsBond != null)
                code = code ^ pattern.excludedLhsBond.hashCode();
            if (pattern.rhsBond != null)
                code = code ^ pattern.rhsBond.hashCode();
        }
        return code;
    }
