...
public class PatternSet extends RuleSet {
    ...
    void addEnergyRule(RuleSyntax s) {
        ...
        EnergyRulePattern p =
            new EnergyRulePattern(getPrefix(source), source, s.getValue("t"), s.getValue("n"), Double.parseDouble(s.getValue("e")), Double.parseDouble(s.getValue("l")), Double.parseDouble(s.getValue("L")), Double.parseDouble(s.getValue("m")), Double.parseDouble(s.getValue("a")), Double.parseDouble(s.getValue("A")),
                                  Double.parseDouble(s.getValue("b")));
